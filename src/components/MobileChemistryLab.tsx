...
const CHEMICALS: Record<string, Chemical> = {
  'CuO': { id: 'CuO', name: 'Đồng(II) oxit', formula: '$CuO$', state: 'solid', color: '#1a1a1a', role: 'Chất oxi hóa', desc: 'Chất rắn màu đen' },
  'CO': { id: 'CO', name: 'Cacbon monoxit', formula: '$CO$', state: 'gas', color: '#e2e8f0', role: 'Chất khử', desc: 'Khí không màu' },
  'Fe': { id: 'Fe', name: 'Sắt', formula: '$Fe$', state: 'solid', color: '#71717a', role: 'Chất khử', desc: 'Kim loại màu xám' },
  'CuSO4': { id: 'CuSO4', name: 'Đồng(II) sunfat', formula: '$CuSO_4$', state: 'liquid', color: '#3b82f6', role: 'Chất oxi hóa', desc: 'Dung dịch màu xanh lam' },
  'CuCl2': { id: 'CuCl2', name: 'Đồng(II) clorua', formula: '$CuCl_2$', state: 'liquid', color: '#0ea5e9', role: 'Chất oxi hóa', desc: 'Dung dịch màu xanh lục' },
  'Al2O3': { id: 'Al2O3', name: 'Nhôm oxit', formula: '$Al_2O_3$', state: 'liquid', color: '#f8fafc', role: 'Chất oxi hóa', desc: 'Trạng thái nóng chảy' },
};
...
const REACTIONS: Reaction[] = [
  {
    ...
    method: 'nhiet_luyen',
    products: [
      { formula: '$Cu$', name: 'Đồng', state: 'solid', color: '#b91c1c' },
      { formula: '$CO_2$', name: 'Cacbon đioxit', state: 'gas', color: '#ffffff' }
    ],
    equation: '$$CuO + CO \\xrightarrow{t^o} Cu + CO_2$$',
  ...
  },
  {
    ...
    method: 'thuy_luyen',
    products: [
      { formula: '$FeSO_4$', name: 'Sắt(II) sunfat', state: 'liquid', color: '#86efac' },
      { formula: '$Cu$', name: 'Đồng', state: 'solid', color: '#b91c1c' }
    ],
  ...
  },
  {
    ...
    products: [
      { formula: '$Cu$', name: 'Đồng', state: 'solid', color: '#b91c1c' },
      { formula: '$Cl_2$', name: 'Clo', state: 'gas', color: '#bef264' }
    ],
            ...
            <div className="h-36 bg-slate-950 border-t border-white/10 p-4 overflow-x-auto flex gap-4 snap-x hide-scrollbar">
              {Object.values(CHEMICALS).map(chem => (
                <button
                  ...
                  disabled={reactionState !== 'idle' && reactionState !== 'error'}
                  className={cn(
                    "snap-center shrink-0 w-24 h-24 rounded-2xl border-2 flex flex-col items-center justify-center gap-2 transition-all",
